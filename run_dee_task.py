...
def parse_args(in_args=None):
    ...
    arg_parser.add_argument('--task_name', type=str, required=False, default='HelloEDAG',
                            help='Take Name')
    ...
    arg_parser.add_argument('--re_eval_by_epoch', type=strtobool, default=False,
                            help='Whether to re-evaluate previous epoch predictions')
...
if __name__ == '__main__':
    ...
    if in_argv.re_eval_by_epoch:
        epoch_num = len(os.listdir(dee_task.setting.model_dir))
        for epoch in range(1, epoch_num + 1):
            dee_task.resume_save_eval_at(epoch, resume_cpt_flag=True, save_cpt_flag=False)
